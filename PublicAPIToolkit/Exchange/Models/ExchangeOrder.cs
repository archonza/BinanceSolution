...
namespace PublicAPIToolkit.Exchange.Models
{
   public class ExchangeOrder
   {
      ...
      public EExchangeOrderState TradeState { get; set; } = EExchangeOrderState.UNINITIALISED;
      public bool TrailingProfitTarget { get; set; }
      public bool TrailingStopLoss { get; set; }
      public EExchangeOrderType TradeOrderType { get; set; }
